 ...
 */
public class PetProfileView extends LinearLayout {
    ...
    public void updateStateItemView(final StateItem stateItem) {
        ...
        stateOwnerPhoto.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ActivityTransition.startUserActivity(context);
            }
        });
        ...
        isFollowed.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        Picasso.with(context)
                ...
                .centerCrop()
                .into(stateBodyImage);
        stateBodyImage.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
